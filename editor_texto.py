...
class Editor(tk.Tk):
    def __init__(self):
        ...
        # Configuracion mínima de la segunda columna
        self.columnconfigure(1, minsize=600, weight=1)
        #Atributo de campo de texto
        self.campo_texto = tk.Text(self, wrap=tk.WORD) #wrap es para que las palabras queden completas al final
        #Atributo de archivo
        self.archivo = None
    ...
    def _crear_menu(self):
        ...
        menu_archivo = tk.Menu(menu_app, tearoff=False) #tearoff es para que no se pueda separar de la app
    ...
    def _abrir_archivo(self):
        ...
        # Eliminamos el texto anterior (en caso de que abramos otro archivo)
    ...
    def _guardar(self):
        ...
        if self.archivo_abierto:
            ...
            with open(self.archivo_abierto.name, 'w') as self.archivo:
                ...
                # Escribimos el contenido del mismo archivo
    ...
    def _guardar_como(self):
        ...
        with open(self.archivo, 'w') as archivo:
            ...
            self.title(f'Editar Texto - {archivo.name}')
...
#En los command de la creacion de los componentes, recuerda no poner los () de los metodos
#A no se que se utilice el metodo lambda entonces se incluye los parentesis, pero con sus parametros
